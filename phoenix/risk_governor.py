...
def evaluate_risk(
    ...
    *,
    ...
    if action in OPEN_ACTIONS:
        ...
        _check_entry_safety_paths(system_status, blocked_by)
...
def _check_entry_safety_paths(system_status: dict[str, Any], blocked_by: list[str]) -> None:
...
def _check_direction(
    ...
    if regime == "HIGH_VOL" and lock != "NO_TRADE":
        lock = "NO_TRADE"
    if lock == "NO_TRADE" and not is_micro_scalp:
