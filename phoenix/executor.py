...
from phoenix.exchange_filter_feasibility import parse_symbol_exchange_filters
...
class PhoenixExecutor:
    ...
    async def get_symbol_rules(self, symbol: str) -> SymbolRules:
        ...
        for item in self._exchange_info_cache["symbols"]:
            ...
            parsed = parse_symbol_exchange_filters(item)
            return SymbolRules(
                symbol=symbol,
                ...
                trigger_protect=parsed.trigger_protect,
