...
BASE_OUTPUT = ROOT / "hermes_logs/stage2_cycle3_single_micro"
...
def _gate_errors(
    *,
    ...
    if str(regime.get("regime") or "UNKNOWN").upper() == "UNKNOWN":
...
async def main() -> int:
    ...
    report_path = run_dir / "stage2_micro_cycle3_report.json"
