...
def experiment_trade_metadata(experiment: dict[str, Any] | None) -> dict[str, Any]:
    ...
    return {
        ...
        "baseline_id": None,
        "strategy_id": experiment.get("strategy_id"),
        "strategy_manifest_id": experiment.get("strategy_manifest_id") or experiment.get("manifest_id"),
        ...
        "cost_model_version": experiment.get("cost_model_version"),
        "regime_model_version": experiment.get("regime_model_version"),
        "data_snapshot_id": experiment.get("data_snapshot_id"),
        "code_git_sha": experiment.get("code_git_sha"),
