...
RUN_ROOT = ROOT / "hermes_logs/stage2_testnet_exploration_v04"
    ...
    report.update(
        {
            ...
            "entry_quality_policy_version": ENTRY_QUALITY_POLICY_VERSION,
            "expected_policy_version": EXPECTED_POLICY_VERSION,
        }
    )
    _write_json(session_dir / "stage2_testnet_exploration_v04_session_report.json", report)
    return report
